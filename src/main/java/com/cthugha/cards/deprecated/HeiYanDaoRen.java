...
import com.cthugha.power.HeiYanDaoRenPower;
...
@Deprecated
@AutoAdd.Ignore
public class HeiYanDaoRen extends AbstractCthughaCard {

    public static final String ID = CthughaHelper.makeID(HeiYanDaoRen.class.getSimpleName());
