...
public class DianJiangChun_QingJiXiShang extends AbstractCthughaCard {

    public static final String ID = CthughaHelper.makeID(DianJiangChun_QingJiXiShang.class.getSimpleName());
