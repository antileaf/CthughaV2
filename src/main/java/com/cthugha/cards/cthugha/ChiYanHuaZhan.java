...
public class ChiYanHuaZhan extends AbstractCthughaCard {
    ...
    public static final String ID = CthughaHelper.makeID(ChiYanHuaZhan.class.getSimpleName());
    ...
    public ChiYanHuaZhan() {
        ...
        AbstractCard card = CthughaHelper.getAttackBurn();
        card.upgrade();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (int i = 0; i < this.secondaryMagicNumber; i++) {
            AbstractCard tmp = CthughaHelper.getAttackBurn();
            tmp.upgrade();
