package com.cthugha.patches.skin;
...
public class SkinSelectPatch {
	...
	@SpirePatch(clz = CharacterSelectScreen.class, method = "open", paramtypez = {boolean.class})
	public static class OpenPatch {
		@SpirePostfixPatch
		public static void Postfix(CharacterSelectScreen _inst, boolean isEndless) {
